...
-- Design Ports Information
-- HEX[3]	=>  Location: PIN_AA26,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- HEX[2]	=>  Location: PIN_Y25,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \inst2|dec_out[3]~0_combout\ : std_logic;
...
SIGNAL \inst2|dec_out[2]~1_combout\ : std_logic;
...
SIGNAL \inst2|dec_out[1]~2_combout\ : std_logic;
...
SIGNAL \inst2|dec_out[0]~3_combout\ : std_logic;
...
\inst2|dec_out[3]~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst2|dec_out[3]~0_combout\ = (\inst|Mux0~3_combout\ & \KEY[0]~input_o\)
...
PORT MAP (
	...
	datad => \KEY[0]~input_o\,
	combout => \inst2|dec_out[3]~0_combout\);
...
\inst2|dec_out[2]~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst2|dec_out[2]~1_combout\ = (\inst|Mux1~1_combout\ & \KEY[0]~input_o\)
...
PORT MAP (
	...
	datad => \KEY[0]~input_o\,
	combout => \inst2|dec_out[2]~1_combout\);
...
-- Equation(s):
-- \inst|Mux2~1_combout\ = (\inst|Mux2~0_combout\ & (((!\inst|Mux0~0_combout\)) # (!\inst|Div0|auto_generated|divider|divider|selnose\(10)))) # (!\inst|Mux2~0_combout\ & (((\inst|Mux2~3_combout\ & \inst|Mux0~0_combout\))))
...
\inst2|dec_out[1]~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst2|dec_out[1]~2_combout\ = (\inst|Mux2~1_combout\ & \KEY[0]~input_o\)
...
PORT MAP (
	...
	datad => \KEY[0]~input_o\,
	combout => \inst2|dec_out[1]~2_combout\);
...
\inst2|dec_out[0]~3\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst2|dec_out[0]~3_combout\ = (\inst|Mux3~4_combout\ & \KEY[0]~input_o\)
...
PORT MAP (
	...
	datad => \KEY[0]~input_o\,
	combout => \inst2|dec_out[0]~3_combout\);
