...
-- Equation(s):
-- \reg|dataOut[1]~7_combout\ = (\dataIn[1]~input_o\ & ((\reg|dataOut\(1) & (\reg|dataOut[0]~5\ & VCC)) # (!\reg|dataOut\(1) & (!\reg|dataOut[0]~5\)))) # (!\dataIn[1]~input_o\ & ((\reg|dataOut\(1) & (!\reg|dataOut[0]~5\)) # (!\reg|dataOut\(1) & 
-- ((\reg|dataOut[0]~5\) # (GND)))))
-- \reg|dataOut[1]~8\ = CARRY((\dataIn[1]~input_o\ & (!\reg|dataOut\(1) & !\reg|dataOut[0]~5\)) # (!\dataIn[1]~input_o\ & ((!\reg|dataOut[0]~5\) # (!\reg|dataOut\(1)))))
...
-- Equation(s):
-- \reg|dataOut[3]~11_combout\ = \dataIn[3]~input_o\ $ (\reg|dataOut[2]~10\ $ (\reg|dataOut\(3)))
